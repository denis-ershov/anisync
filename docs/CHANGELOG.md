...
## 2026-09-25 (fix: anime schedule card showing next week releases in today section)
...
2. **Корректное распределение по блокам интерфейса:**
...
3. **Тестирование:**
   ...
   - Добавлены проверки для эпизодов через 6 дней (день 6) и эпизодов, выходящих сегодня позже. Все 105 тестов успешно проходят.
