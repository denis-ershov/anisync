...
## 2026-09-25 (fix: anime schedule card showing next week releases in today section & tomorrow releases showing today)
...
**Изменения:**
1. **Устранение ложного попадания аниме следующей недели в карточку «Сегодня»:**
...
2. **Исправление ошибочного статуса «сегодня HH:mm» для завтрашних серий:**
...
3. **Корректное распределение по блокам интерфейса:**
...
4. **Тестирование:**
   ...
   - Добавлены проверки для `formatNextEpisodeShort` на разделение «сегодня» и «завтра», дни 6, 7 и ближайшие часы. Все 105 тестов успешно проходят.
